...
@section('content')
    <section class="text-white bg-stone-900 body-font">
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <h1 class="title-font sm:text-4xl text-3xl mb-16 font-medium text-white">{{__('message.intern_h1')}}<span class="text-orange-600">{{__('message.intern_span1')}}</h1>
            ...
            <div class="bar2"></div>
            <h1 class="title-font sm:text-4xl text-3xl mb-16 font-medium text-white">{{__('message.intern_h2')}}<span class="text-orange-600">{{__('message.intern_span2')}}</h1>
            <div class="flex flex-col items-center justify-between lg:flex-row">
                <div class="animate__animated animate__fadeIn animate__slow relative lg:w-1/2">
