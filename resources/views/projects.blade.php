    ...
    <div class="flex w-full justify-center">
        <ul class="nav nav-tabs flex flex-row content-center flex-wrap list-none border-b-0 mb-5 mt-8" id="tabs-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="#web" class="nav-link block font-medium text-xs leading-tight uppercase border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:border-orange-600 transition duration-300 ease-in-out focus:border-orange-600 border-orange-600" id="tabs-web-tab" data-bs-toggle="pill" data-bs-target="#tabs-web" role="tab" aria-controls="tabs-web" aria-selected="true">{{__('message.project_a1')}}</a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="#software" class="nav-link block font-medium text-xs leading-tight uppercase border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:border-orange-600 transition duration-300 ease-in-out focus:border-orange-600" id="tabs-software-tab" data-bs-toggle="pill" data-bs-target="#tabs-software" role="tab" aria-controls="tabs-software" aria-selected="false">{{__('message.project_a2')}}</a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="#networking" class="nav-link block font-medium text-xs leading-tight uppercase border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:border-orange-600 transition duration-300 ease-in-out focus:border-orange-600" id="tabs-networking-tab" data-bs-toggle="pill" data-bs-target="#tabs-networking" role="tab" aria-controls="tabs-networking" aria-selected="false">{{__('message.project_a3')}}</a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="#others" class="nav-link block font-medium text-xs leading-tight uppercase border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:border-orange-600 transition duration-300 ease-in-out focus:border-orange-600" id="tabs-others-tab" data-bs-toggle="pill" data-bs-target="#tabs-others" role="tab" aria-controls="tabs-others" aria-selected="false">{{__('message.project_a4')}}</a>
            </li>
        </ul>
    </div>
